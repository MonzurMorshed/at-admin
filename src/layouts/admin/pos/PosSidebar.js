...
import {AiOutlineHome,AiOutlineShoppingCart,AiOutlineHistory} from 'react-icons/ai';
...
const PosSidebar = () => {
    return (
        <nav className="sb-sidenav accordion" id="sidenavAccordion" style={{backgroundColor: "#fff"}}>
            <div className="sb-sidenav-menu">
                <div className="nav mx-2 my-2">
                    
                    <Link className="nav-link" to="/admin/pos/home">
                        <AiOutlineHome/>
                        Home
                    </Link>

                    <Link className="nav-link" to="/admin/pos/sale">
                        <AiOutlineShoppingCart/>
                        Sale
                    </Link>

                    <Link className="nav-link" to="/admin/pos/inventory">
                        <RiMotorbikeFill/>
                        Inventory
                    </Link>

                    <Link className="nav-link" to="/admin/pos/history">
                        <AiOutlineHistory/>
                        History
                    </Link>

                    <Link className="nav-link" to="/admin/pos/promos">
                        <BiPurchaseTagAlt/>
                        Promos
                    </Link>

                    <Link className="nav-link" to="/admin/pos/premium">
                        <FaCrown/>
                        Premium
                    </Link>
